...
NachenBlaster::NachenBlaster(StudentWorld* world) : Spaceship(IID_NACHENBLASTER, 0, 128, 0, 1.0, 50.0, 0.0, world, 0), m_cabbage(30)
{}
...
Smallgon::Smallgon(int xPos, int yPos, int dir, StudentWorld* world) : Spaceship(IID_SMALLGON, xPos, yPos, 0, 1.5, dir, 2.0, world, 1)
{}
